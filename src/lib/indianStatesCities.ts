// All 28 Indian states + 8 union territories, each mapped to its COMPLETE list of
// districts (the standard, stable administrative unit) — used as suggestions for the
// dependent City/Town field. The City/Town input always accepts free typing on top of
// these suggestions, so a specific town/city not listed here can still be entered.
...
export const CITIES_BY_STATE: Record<IndianState, string[]> = {
  ...
  "Arunachal Pradesh": [
    ...
    "Tawang", "Tirap", "Upper Dibang Valley", "Upper Siang", "Upper Subansiri", "West Kameng",
    "West Siang",
  ],
  Assam: [
  ...
  Rajasthan: [
    ...
    "Sawai Madhopur", "Sikar", "Sirohi", "Shahpura", "Tonk", "Udaipur",
  ],
